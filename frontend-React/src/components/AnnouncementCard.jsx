    ...
    <div className="card-hover p-6 group relative transition-all duration-300 hover:scale-[1.01]">
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 bg-neutral-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="card p-8 max-w-md w-full mx-4 animate-slide-in-right shadow-2xl">
            ...
            <p className="text-neutral-600 mb-8 leading-relaxed">
              Êtes-vous sûr de vouloir supprimer cette annonce ? Cette action est <strong className="text-neutral-900">irréversible</strong> et l'annonce sera définitivement supprimée.
            </p>
